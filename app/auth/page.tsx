...
import { Pill, User, Mail, Lock, ArrowLeft } from "lucide-react";
...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-20 w-32 h-32 bg-medical-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"></div>
      <div
        className="absolute bottom-20 right-20 w-32 h-32 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="pt-2">
              ...
              <div className="flex gap-4 mt-2 justify-center">
                ...
                <button
                  type="button"
                  className="group flex items-center justify-center gap-0 hover:gap-3 bg-white border border-slate-200 hover:border-slate-300 text-slate-600 p-3 rounded-xl transition-all duration-300 hover:w-32 hover:bg-slate-50 w-12 h-12 overflow-hidden shadow-sm"
                >
                  <svg
                  ...
                  <span className="opacity-0 group-hover:opacity-100 whitespace-nowrap text-sm font-medium transition-opacity duration-300 w-0 group-hover:w-auto">
                    Google
                  </span>
                </button>
                ...
                <button
                  type="button"
                  className="group flex items-center justify-center gap-0 hover:gap-3 bg-slate-900 border border-transparent text-white p-3 rounded-xl transition-all duration-300 hover:w-32 hover:bg-slate-800 w-12 h-12 overflow-hidden shadow-sm shadow-slate-900/20"
                >
                  <svg
