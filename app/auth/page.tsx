            ...
            <div className="pt-2">
              ...
              <div className="flex gap-4 mt-2 justify-center">
                ...
                >
                  ...
                  <span className="opacity-0 group-hover:opacity-100 max-w-0 group-hover:max-w-[100px] whitespace-nowrap text-sm font-medium transition-all duration-300 ease-in-out">
                    Google
                  </span>
                </button>
                ...
                <button
                  ...
                  className="group flex items-center justify-center gap-0 hover:gap-3 bg-slate-900 border border-transparent text-white p-3 rounded-xl transition-all duration-300 hover:w-36 hover:bg-slate-800 w-12 h-12 overflow-hidden shadow-sm shadow-slate-900/20"
                >
                  <svg
