      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center">
            ...
            {/* Glass Card Mockup */}
            <div className="relative w-full max-w-md glass-card rounded-2xl p-6 md:p-8 transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900">Cardiology</h3>
                    <p className="text-sm text-slate-500">32 Topics • 85% Complete</p>
                  </div>
                </div>
                <div className="text-right">
                  <span className="block text-2xl font-bold text-slate-900">A+</span>
                  <span className="text-xs text-slate-500 font-medium">Current Grade</span>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-slate-900">28/32 Modules</span>
                </div>
              </div>
            ...
            {/* Floating Elements */}
            <div className="absolute -top-4 -right-4 bg-white p-4 rounded-xl shadow-xl animate-float">
              <div className="flex items-center gap-2">
                <Trophy className="w-5 h-5 text-yellow-500" />
                <span className="font-bold text-slate-900">Streak: 7 Days!</span>
              </div>
            </div>
